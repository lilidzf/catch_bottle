...
//    sleep(2);
    ...
    ur5e_gripper.add_box(collision_object,bottle_height,bottle_x_y_z,"box1");

    moveit_msgs::CollisionObject collision_object_1;
    collision_object_1.header.frame_id = move_group.getPlanningFrame();
