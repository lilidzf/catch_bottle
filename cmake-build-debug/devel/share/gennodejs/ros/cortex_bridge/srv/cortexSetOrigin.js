...
class cortexSetOriginRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cortexSetOriginRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cortexSetOriginRequest
    let len;
    let data = new cortexSetOriginRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new cortexSetOriginRequest(null);
...
class cortexSetOriginResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type cortexSetOriginResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type cortexSetOriginResponse
    let len;
    let data = new cortexSetOriginResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new cortexSetOriginResponse(null);
...
module.exports = {
  Request: cortexSetOriginRequest,
  Response: cortexSetOriginResponse,
  md5sum() { return '541ae416aa7d89272790d7e1bcc39770'; },
  datatype() { return 'cortex_bridge/cortexSetOrigin'; }
};
